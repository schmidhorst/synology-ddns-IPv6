...
Ihr Internet-Router unterstützt möglicherweise DDNS einschließlich IPv6, aber dies wird manchmal keine Lösung sein, um von außen über IPv6 auf Ihr Synology zuzugreifen. Wenn Sie eine globale IPv4-Adresse haben, ist diese gemeinsam für den Router und z.B. Ihr Synology-NAS (via NAT). Aber Ihr Router und Ihr Synology haben unterschiedliche globale IPv6-Adressen. Der DDNS-Dienst des Routers macht für IPv6 u.U. nur den Router von außen zugänglich, nicht aber Ihr NAS. Dann ist eine DynDNS-Update-Routine einschließlich IPv6 auf dem Synology erforderlich, um Dienste auf dem Synology über IPv6 von außen verfügbar zu machen und nicht nur Ihren Router.
...
- Nach einem DSM-Versions-Update müssen u.U. die Schritte 2 und 3 wiederholt werden! Es kann auch in der Systemsteuerung im Aufgabenplaner eine "Ausgelöste Aufgabe" erstellt und das setup.sh-Skript bei jedem Reboot als root-User erneut ausgeführt werden. Dann braucht man beim Versionsupdate nicht mehr daran zu denken.
